# Проектная работа
__Тема__: Развертывание веб-приложения на базе фрейма _Flask_ с использованием балансировки нагрузки средствами _Nginx_. Применение стека _Flask_ + _Nginx_ + _MySQL_.
